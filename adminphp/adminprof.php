...
<body class="bg-[#FFF9E5] font-sans text-gray-800">
    ...
    <div class="flex items-center">
        ...
        <a href="../adminphp/adminprof.php" class="w-8 h-8 bg-black rounded-full block overflow-hidden" id="headerProfilePic">
            <!-- If there's a profile picture, display it here -->
            <?php if(isset($_SESSION['profilePicture']) && !empty($_SESSION['profilePicture'])): ?>
                <img src="<?php echo $_SESSION['profilePicture']; ?>" alt="Profile" class="w-full h-full object-cover">
            <?php endif; ?>
        </a>
    </div>
</div>
