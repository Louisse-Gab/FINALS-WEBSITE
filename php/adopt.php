...
<nav class="flex space-x-8 text-base uppercase font-bold">
  ...
  <main class="container mx-auto px-6 py-8">
    <section class="mb-12">
      <div class="flex items-center justify-between bg-[#FFF2CD] px-4 py-3 rounded-md mb-6">
        ...
        <!-- Cat Card 3 -->
        <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
          <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Jalapeno.jpg" alt="Jalapeno" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
      ...
      <div id="dog-section" class="mt-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <!-- Dog Card 1 -->
          <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
            <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Miky.jpg" alt="Miky" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
          ...
          <!-- Dog Card 2 -->
          <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
            <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Hany.jpg" alt="Hany" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
          ...
          <!-- Dog Card 3 -->
          <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
            <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Belle.jpg" alt="Belle" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
          ...
          <!-- New Dog Card 4 - Snoopy -->
          <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
            <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Snoopy.jpg" alt="Snoopy" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
          ...
          <!-- New Dog Card 5 - Tofu -->
          <div class="bg-white border border-gray-300 rounded-md p-4 text-center shadow-sm hover:shadow-md transition">
            <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Tofu.jpg" alt="Tofu" class="w-32 h-32 object-cover rounded-full mx-auto mb-4" />
  ...
  <div id="modal-tabasco" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Tabasco.jpg" alt="Tabasco" class="w-48 h-48 object-cover rounded-full mb-4">
  ...
  <div id="modal-cayenne" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Cayenne.jpg" alt="Cayenne" class="w-48 h-48 object-cover rounded-full mb-4">
  ...
  <div id="modal-jalapeno" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Jalapeno.jpg" alt="Jalapeño" class="w-48 h-48 object-cover rounded-full mb-4">
  ...
  <div id="modal-miky" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Miky.jpg" alt="Miky" class="w-48 h-48 object-cover rounded-full mb-4">
  ...
  <div id="modal-hany" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Hany.jpg" alt="Hany" class="w-48 h-48 object-cover rounded-full mb-4">
  ...
  <div id="modal-belle" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
      ...
      <div class="flex flex-col items-center">
        <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Belle.jpg" alt="Belle" class="w-48 h-48 object-cover rounded-full mb-4">
...
<div id="modal-snoopy" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
  <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
    ...
    <div class="flex flex-col items-center">
      <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Snoopy.jpg" alt="Snoopy" class="w-48 h-48 object-cover rounded-full mb-4">
      ...
      <div class="text-left w-full">
        ...
        <p class="text-gray-700 mb-4">Snoopy is one of Akira's pups who was neglected by previous owners and later surrendered when he got sick. Diagnosed with parvo, he is now under care and fighting through with strength and resilience. He'll be moving to a loving foster home this week. Very playful and sweet.</p>
        <a href="adoptlogin.php" class="block bg-[#FFBB00] text-white font-bold px-4 py-2 rounded hover:bg-yellow-500 w-full text-center">Adopt Me</a>
      </div>
    </div>
  </div>
...
<div id="modal-tofu" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
  <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
    ...
    <div class="flex flex-col items-center">
      <img src="../images/SHELTER OF LIGHT/ADOPT PAGE/Tofu.jpg" alt="Tofu" class="w-48 h-48 object-cover rounded-full mb-4">
      ...
      <div class="text-left w-full">
        ...
        <p class="text-gray-700 mb-2"><span class="font-semibold">Vaccinated:</span> 5-1 x2</p>
        <p class="text-gray-700 mb-2"><span class="font-semibold">Neutered:</span> Yes</p>
        <p class="text-gray-700 mb-4">Surrendered by previous owners after neglect and lack of medical care. They only gave him up when he became seriously ill. Tofu is now under the care of Shelter of Light with the help of Lala's Haven. Very playful and sweet.</p>
        <a href="adoptlogin.php" class="block bg-[#FFBB00] text-white font-bold px-4 py-2 rounded hover:bg-yellow-500 w-full text-center">Adopt Me</a>
      </div>
    </div>
  </div>
