...
<head>
  ...
  <title>Spay and Neuter | Shelter of Light</title>
...
<main class="py-12">
  <div class="container mx-auto px-4 max-w-4xl">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
      <img src="../../images/SHELTER OF LIGHT/WHAT WE DO PAGE/Programs/Programs 3.jpg" alt="Spay and Neuter" class="w-full h-64 object-cover">
      <div class="p-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Spay and Neuter Program</h1>
