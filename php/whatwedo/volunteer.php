...
<head>
  ...
  <title>Volunteers| Shelter of Light</title>
...
<main class="py-12">
  <div class="container mx-auto px-4 max-w-4xl">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
      <img src="../../images/SHELTER OF LIGHT/WHAT WE DO PAGE/Volunteers/Volunteer 3 .jpeg" alt="Volunteer" class="w-full h-64 object-cover">
      <div class="p-8 text-justify">
        <h1 class="text-3xl font-bold mb-6 text-center">Volunteer Opportunities</h1>
