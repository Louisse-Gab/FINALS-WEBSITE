            ...
            <div class="contact-icons">
                ...
                <div class="contact-item">
                    <div class="contact-icon-wrapper">
                        ...
                        <span class="font-medium">CONTACT NUM</span>
                        <span class="contact-detail">0977 211 9959</span>
                    </div>
                </div>
                ...
                <div class="contact-item">
                    <div class="contact-icon-wrapper">
                        ...
                        <span class="contact-detail">shelteroflightph@gmail.com</span>
                    </div>
                </div>
                
                <!-- Instagram - Clickable with updated link -->
                <div class="contact-item">
                    <a href="https://www.instagram.com/shelteroflightph?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" class="contact-icon-wrapper">
                ...
                <div class="contact-item">
                    <a href="https://web.facebook.com/shelteroflightph" target="_blank" rel="noopener noreferrer" class="contact-icon-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" class="contact-icon" fill="currentColor" viewBox="0 0 24 24">
