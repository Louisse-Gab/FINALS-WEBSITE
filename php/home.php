    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-[#FFFBE9] absolute w-full z-10 shadow-md">
      <div class="container mx-auto px-4">
        <div class="flex flex-col space-y-3 text-sm uppercase font-bold py-4">
          ...
          <a href="../php/whatwedo/whatwedo.php" class="hover:text-[#FFBB00] py-2 border-b border-gray-200">What We
            Do</a>
    ...
    <section class="bg-[#FFFBDE] py-8 lg:py-12">
      <div class="container mx-auto text-center px-4">
        <div class="flex flex-col lg:flex-row justify-center items-center">
          <img src="../images/SHELTER OF LIGHT/PAW-LOGO.png" alt="Paw Logo"
            class="w-20 h-20 lg:w-24 lg:h-24 lg:mr-4 mb-4 lg:mb-0">
    ...
    <section class="text-gray-800 py-8 lg:py-12 px-4 lg:px-6">
      <div class="container mx-auto">
        <p class="text-center leading-relaxed text-base lg:text-lg">
          Welcome to the Shelter of Light website. This platform serves as a central space where visitors can learn more
          about who we are, what we do, and how we continue to grow as a faith-centered community. Whether you're a
          member, a supporter, or someone new to our shelter, this website provides a clear overview of our journey,
          programs, and vision.
        </p>
        <p class="text-center leading-relaxed mt-4 lg:mt-6 text-base lg:text-lg">
          Our shelter provides comprehensive rehabilitation, from emergency medical treatment to emotional recovery and
          socialization. Through our adoption program, we carefully match animals with loving forever homes. The website
          shares heartwarming rescue stories, updates on current residents, and resources about responsible pet care.
          You'll also find practical ways to support our mission through donations, volunteering, or adoption.

        </p>
        <p class="text-center leading-relaxed mt-4 lg:mt-6 text-base lg:text-lg">
          Every animal deserves safety, dignity, and compassion. At Shelter of Light, we work tirelessly to make that
          vision a reality - one rescue at a time. Join us in creating brighter futures for animals in need.
        </p>
      </div>
    </section>
          ...
          <div class="multi-carousel-track" id="multi-carousel-track">
            ...
            <div class="multi-carousel-slide">
              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Mallows.jpg" alt="Mallows"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
                  <h3 class="font-bold text-lg text-center">Mallows</h3>
                  <p class="text-sm text-center mt-1">This sweet fluff found the warm, loving home he always deserved.
                  </p>
                </div>
              </div>

              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Mocha.jpg" alt="Mocha"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
              ...
              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Anino.jpg" alt="Anino"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
            ...
            <div class="multi-carousel-slide">
              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Chance.jpg" alt="Chance"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
              ...
              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Sabrina.jpg" alt="Sabrina"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
              ...
              <div class="multi-carousel-item">
                <img src="../images/SHELTER OF LIGHT/HOME PAGE/Latest Pet Adopted/Star.jpeg" alt="Star"
                  class="w-full h-full object-cover">
                <div class="pet-info-overlay">
                  <h3 class="font-bold text-lg text-center">Star</h3>
                  <p class="text-sm text-center mt-1">From shelter to shining star — now glowing in her forever home.
                  </p>
                </div>
              </div>
            </div>
    ...
    <section class="bg-black text-white py-8 lg:py-12">
      <div class="container mx-auto text-center px-4">
        <h3 class="text-base lg:text-lg font-bold mb-4">
          In total, Shelter of Light has aided, helped, loved, fed, and cared for
        </h3>
        <p class="text-xl lg:text-2xl font-bold">
          Around <?= $animal_counts['Dog'] + $animal_counts['Cat'] ?> Animals
        </p>
        <div
          class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 lg:space-x-10 mt-6 lg:mt-8">
          <div class="text-center">
            <p class="text-[#FFBB00] text-2xl lg:text-3xl font-bold"><?= $animal_counts['Dog'] ?></p>
            <p>Dogs</p>
          </div>
          <div class="text-center">
            <p class="text-[#FFBB00] text-2xl lg:text-3xl font-bold"><?= $animal_counts['Cat'] ?></p>
            <p>Cats</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col lg:flex-row justify-between items-center gap-4 text-center lg:text-left">
        ...
        <div class="order-2 lg:order-1 flex flex-col items-center lg:items-start gap-2">
          ...
          <div class="flex justify-center gap-4">
            ...
            <a href="https://www.instagram.com/shelteroflightph?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              class="text-[#5F4B32] hover:text-[#FFBB00]">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path
